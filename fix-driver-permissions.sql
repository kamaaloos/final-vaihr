-- Fix permissions for drivers (non-admin users)
-- This script ensures drivers can access their own data
...
-- Create user policies (for all authenticated users including drivers)
