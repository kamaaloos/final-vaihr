-- Complete database setup for new Supabase project (Version 2)
...
-- 7. Create chat_relationship table
...
-- 8. Create chats table (if not exists)
...
-- 10. Create messages table (if not exists)
...
-- 11. Create invoices table (if not exists)
...
ALTER TABLE chat_relationship ENABLE ROW LEVEL SECURITY;
