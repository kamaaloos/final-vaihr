-- Fix security for views by recreating them with proper security (Final - No RLS on views)
...
-- The views will automatically respect the RLS policies on the 'chats' table
