-- Create the missing complete_job_and_create_invoice function
-- This function completes a job and creates an invoice

CREATE OR REPLACE FUNCTION public.complete_job_and_create_invoice(params JSONB)
RETURNS UUID
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
GRANT EXECUTE ON FUNCTION public.complete_job_and_create_invoice(JSONB) TO authenticated;

-- Test the function (optional)
-- SELECT public.complete_job_and_create_invoice('{"job_id": "your-job-id", "duration_minutes": 60, "rate_per_hour": 25.00}');
